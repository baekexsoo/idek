...
@Component({
  selector: 'app-acheteurs-form',
  templateUrl: './acheteurs-form.component.html',
  styleUrls: ['./acheteurs-form.component.css']
})
export class AcheteursFormComponent implements OnInit {
